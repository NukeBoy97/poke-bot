...
def check_stock(url, text):
    ...
    if 'target.com' in url_lower:
        # Trust out of stock signals first
        target_out_words = [
            'out of stock',
            'sold out',
            'currently unavailable',
        ...
        # Only call IN_STOCK if we see very specific active purchase signals
        # AND no out of stock signals above
        target_in_words = [
            'add to cart',
            'ship it',
            'pick up',
        ...
        # Require at least 2 in-stock signals to reduce false positives
